...
-MPI_Send и MPI_Recv используется для сбора результатов
...
|-------|----------|----------|-----------|---------------|
| seq   | 1        | 0.010613 | 1.00      | 100.0%        |
| mpi   | 4        | 0.004436 | 2.39      | 59.8%         |

**Время выполнения (pipeline) - полный цикл**

| Режим | Процессы | Время, с | Ускорение | Эффективность |
|-------|----------|----------|-----------|---------------|
| seq   | 1        | 0.010562 | 1.00      | 100.0%        |
| mpi   | 4        | 0.002711 | 3.90      | 97.5%         |
