...
class BaranovARunFuncTestsProcesses : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_baranov_a_sign_alternations, "pic.jpg");
...
TEST_P(BaranovARunFuncTestsProcesses, MatmulFromPic) {
...
const auto kPerfTestName = BaranovARunFuncTestsProcesses::PrintFuncTestName<BaranovARunFuncTestsProcesses>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, BaranovARunFuncTestsProcesses, kGtestValues, kPerfTestName);
