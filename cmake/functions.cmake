...
function(ppc_add_test test_name test_src USE_FLAG)
  if(${USE_FLAG})
    add_executable(
      ...
      "../tasks/example_processes_2 (2)/mpi/src/ops_mpi.cpp"
      "../tasks/example_processes_2 (2)/seq/src/ops_seq.cpp"
      "../tasks/example_processes_2 (2)/tests/functional/main.cpp"
      "../tasks/example_processes_2 (2)/tests/performance/main.cpp")
    enable_testing()
